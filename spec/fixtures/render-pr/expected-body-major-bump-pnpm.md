...
|---|---|---|
| 3.18.1 | GHSA-p6mc-m468-83gw | no patched release in the 3.x line; needs a major bump of the dependent that pins it (not derivable from this report) or dropping it |
