...
- **Phases 2, 4, 5 and 7 are `<scripts_dir>/audit-pins-driver.sh`, and you never re-derive them.**
  The driver is the single home of that procedure (`plugins/gh-security/docs/GUIDE.md`, "The pin-audit driver owns
...
- **Repo-global git state is not yours.** You may add and remove your own worktree, and nothing
  ...
  of what dispatched it. See `plugins/gh-security/docs/GUIDE.md`, "Repo-global git state belongs to the
  orchestrator".
- **When `env_prefix` is present in your dispatch, it runs in front of every `gh`, `git`,
  ...
  dispatcher was given none, which is the ordinary ambient-login case (see `plugins/gh-security/docs/GUIDE.md`,
