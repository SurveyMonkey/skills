...
**The conventions, the domain rules and the testing policy are one directory up, in
[`plugins/gh-security/CLAUDE.md`](../CLAUDE.md)**, whose "Bash during the port" section carries
the bash 3.2 and jq 1.7 targets these two scripts are written to.
