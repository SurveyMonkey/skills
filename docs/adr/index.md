...
| [006-pin-removal-prs.md](006-pin-removal-prs.md) | The pin audit opens one draft removal PR per repository, defaulting to PR mode, gated on a combined test of the whole removed set that fails closed on a partial view of the tree. |
