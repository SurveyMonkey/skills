...
| [006-pr-ready-state-and-the-pre-dispatch-checkpoint.md](006-pr-ready-state-and-the-pre-dispatch-checkpoint.md) | Fix PRs open ready for review; the checkpoint moves ahead of `gh pr create` into the dispatch approval, which discloses per repo where auto-merge is permitted. Supersedes 002. |
