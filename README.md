...
- **A merge-risk rating on every PR.** Seven scored factors (version delta, runtime exposure,
  ...
  agent runs your test suite; CI on the pull request is the verifier. Every PR also carries a
  `merge-risk:<band>` label matching its own PR body — `merge-risk:low` (green, `#2da44e`),
