...
`pnpm exec lefthook install`); pre-commit runs the fast gates over staged files only, and pre-push
runs nothing — CI is the enforcement boundary (`.github/workflows/gates.yml`).
